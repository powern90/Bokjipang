...
public class fragment_mypost extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.post_listView);
        ...
        executor.execute(new Runnable(){
            ...
            public void run(){
                try {
                    ...
                    URL url = new URL("https://api.bluemango.site/user/post");
...
//        ArrayList<DataComu> tmp = new ArrayList<DataComu>();
        for(int i = 0 ; i< json_array.length(); i++){
            ...
            dataitem.set_content(tt.getString("content"));
            dataitem.set_like(Integer.toString(tt.getInt("like")));
            dataitem.set_comment(Integer.toString(tt.getInt("reply_count")));
            tmp.add(dataitem);
        }
        return tmp;
    }
